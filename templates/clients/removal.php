...
<h2 class="nav-tab-wrapper">
  <a href="/wp-admin/admin.php?page=vspostman-clients&act=removal" class="nav-tab nav-tab-active">Отписан мной (<?= isset($totals[1]) ? $totals[1] : 0 ?>)</a>
  <a href="/wp-admin/admin.php?page=vspostman-clients&act=removal2" class="nav-tab">Отписался сам (<?= isset($totals[2]) ? $totals[2] : 0 ?>)</a>
